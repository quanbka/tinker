<nav class="navigation-wrapper">
    <ul class="main-menu">
        <li class="main-menu-item is-mobile gotohome-item">
            <a href="/">
                <picture>
                    <source media="(min-width: 320px)" srcset="/images/logo.svg">
        ...
        <li class="main-menu-item">
            <a class="menu-item-link" href="#">
                ...
                <div class="menu-text">Tủ lạnh - Tủ đông - Tủ mát</div>
            </a>

            <div class="main-submenu-wrapper">
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">TỦ LẠNH<a href="/tu-lanh">Tất cả</a></div>
                ...
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">TỦ ĐÔNG, TỦ MÁT<a href="/tu-dong">Tất cả</a></div>
        ...
        <li class="main-menu-item">
            <a class="menu-item-link" href="#">
                <div class="menu-icon">
                    <i class="hg-menu-television"></i>
                </div>
                <div class="menu-text">Tivi - Loa - Dàn Karaoke</div>
            </a>

            <div class="main-submenu-wrapper">
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">MÁY GIẶT<a href="/may-giat">Tất cả</a></div>
                ...
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">MÁY SẤY QUẦN ÁO<a href="/may-say-quan-ao">Tất cả</a></div>
                ...
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">PHỤ KIỆN MÁY GIẶT</div>
        ...
        <li class="main-menu-item">
            <a class="menu-item-link" href="#">
                <div class="menu-icon">
                    <i class="hg-menu-washer"></i>
                </div>
                <div class="menu-text">Máy giặt - Máy nước nóng</div>
            </a>

            <div class="main-submenu-wrapper">
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">MÁY LẠNH<a href="/may-lanh">Tất cả</a></div>
                        <a href="/may-lanh-tra-gop-0-phan-tram">Trả góp 0 - 0.5%</a>
                        <a href="/may-lanh-moi">Đời mới 2020</a>
                ...
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">QUẠT ĐIỀU HÒA<a href="/quat-dieu-hoa">Tất cả</a></div>
                ...
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">Quạt<a href="/quat">Tất cả</a></div>
        ...
        <li class="main-menu-item">
            <a class="menu-item-link" href="#">
                <div class="menu-icon">
                    <i class="hg-menu-phone"></i>
                </div>
                <div class="menu-text">Điện thoại - Tablet - Phụ kiện</div>
            </a>

            <div class="main-submenu-wrapper">
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">NỒI CÁC LOẠI</div>
                    ...
                    <div class="submenu-item-box">
                        <div class="menuitem-title">MÁY XAY - VẮT - ÉP</div>
                ...
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">BẾP - LÒ</div>
                    ...
                    <div class="submenu-item-box">
                        <div class="menuitem-title">THIẾT BỊ NHÀ BẾP</div>
                ...
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">ĐIỆN GIA DỤNG</div>
                ...
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">CHĂM SÓC SỨC KHỎE</div>
                    ...
                    <div class="submenu-item-box">
                        <div class="menuitem-title">THIẾT BỊ LÀM ĐẸP <a href="/thiet-bi-lam-dep">Tất cả</a></div>
                ...
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">DỤNG CỤ SỬA CHỮA</div>
                    ...
                    <div class="submenu-item-box">
                        <div class="menuitem-title">THIẾT BỊ ĐIỆN NƯỚC</div>
        ...
        <li class="main-menu-item">
            <a class="menu-item-link" href="#">
                <div class="menu-icon">
                    <i class="hg-menu-air-conditioner icon-new"></i>
                </div>
                <div class="menu-text">Máy lạnh - Máy lọc không khí</div>
            </a>

            <div class="main-submenu-wrapper">
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">PHÒNG ĂN</div>
                    ...
                    <div class="submenu-item-box">
                        <div class="menuitem-title">VỆ SINH NHÀ CỬA</div>
                ...
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">NHÀ BẾP</div>
                ...
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">CHĂM SÓC MẸ VÀ BÉ <a href="/cham-soc-me-va-be">Tất cả</a></div>
                ...
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">THIẾT BỊ KHÁC</div>
                        <a href="/mu-bao-hiem">Mũ bảo hiểm</a>
                        <a href="/ket-sat">Két sắt, </a>
                        <a href="/o-khoa">Ổ khoá</a>
                    </div>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">THIẾT BỊ PHÒNG TẮM</div>
        ...
        <li class="main-menu-item">
            <a class="menu-item-link" href="#">
                <div class="menu-icon">
                    <i class="hg-menu-chicken-tool"></i>
                </div>
                <div class="menu-text">Đồ gia dụng - Quạt</div>
            </a>

            <div class="main-submenu-wrapper">
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">LỌC NƯỚC</div>
                ...
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">MÁY NƯỚC NÓNG </div>
                        ...
                        <a href="/may-nuoc-nong-centon">Centon</a>
                    </div>
                </aside>
            </div>
        </li>
        <li class="main-menu-item">
            <a class="menu-item-link" href="#">
                <div class="menu-icon">
                    <i class="hg-menu-camera"></i>
                </div>
                <div class="menu-text">Máy ảnh - Máy Quay - Phụ kiện</div>
            </a>

            <div class="main-submenu-wrapper">
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">ĐIỆN THOẠI<a href="/dien-thoai">Tất cả</a></div>
                ...
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">LAPTOP<a href="/laptop-ldp">Tất cả</a></div>
                ...
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">TABLET<a href="/may-tinh-bang">Tất cả</a></div>
                ...
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">MÀN HÌNH<a href="/man-hinh-may-tinh">Tất cả</a></div>
                    ...
                    <div class="submenu-item-box">
                        <div class="menuitem-title">MÁY TÍNH<a href="/may-tinh-nguyen-bo">Tất cả</a></div>
                ...
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">MÁY IN<a href="/may-in">Tất cả</a></div>
        ...
        <li class="main-menu-item">
            ...
            <div class="main-submenu-wrapper">
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">ĐỒNG HỒ THỜI TRANG<a href="/dong-ho">Tất cả</a></div>
                    ...
                    <div class="submenu-item-box">
                        <div class="menuitem-title">ĐỒNG HỒ THÔNG MINH<a href="/dong-ho-thong-minh-ldp">Tất cả</a> </div>
                ...
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">PHỤ KIỆN ĐIỆN THOẠI<a href="/phu-kien">Tất cả</a></div>
                    ...
                    <div class="submenu-item-box">
                        <div class="menuitem-title">PHỤ KIỆN LAPTOP<a href="/phu-kien">Tất cả</a></div>
                        <a href="/usb">USB</a>
                ...
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">PHỤ KIỆN ĐIỆN MÁY</div>
                    ...
                    <div class="submenu-item-box">
                        <div class="menuitem-title">VALI<a href="/vali">Tất cả</a></div>
                        <a href="/vali-sakos">Sakos</a>
                        <a href="/vali-stargo">Stargo</a>
                        <a href="/vali-hung-phat">Hùng Phát</a>
                    </div>
                </aside>
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">THIẾT BỊ MẠNG<a href="/thiet-bi-mang">Tất cả</a></div>
        ...
        <li class="main-menu-item">
            <a class="menu-item-link" href="#">
                <div class="menu-icon">
                    <i class="hg-living-room"></i>
                </div>
                <div class="menu-text">Kinh nghiệm hay - mẹo vặt</div>
            </a>

            <div class="main-submenu-wrapper">
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">Tivi, dàn loa âm thanh</div>
                        <a href="/may-doi-tra/tivi">Tivi</a>
                        <a href="/may-doi-tra/dan-loa-dvd">Loa Karaoke</a>
                        <a href="/may-doi-tra/micro">Micro</a>
                    </div>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">Điện gia dụng<a href="/may-doi-tra/dien-gia-dung">Tất cả</a></div>
                ...
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">Tủ lạnh, tủ đông</div>
                        <a href="/may-doi-tra/tu-lanh">Tủ lạnh</a>
                        <a href="/may-doi-tra/tu-dong">Tủ đông</a>
                    </div>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">Máy lạnh, quạt điều hòa</div>
                ...
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">Máy giặt, máy sấy</div>
                        <a href="/may-doi-tra/may-giat">Máy giặt</a>
                        <a href="/may-doi-tra/may-say-quan-ao">Máy sấy</a>
                    </div>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">Máy lọc nước, nước nóng</div>
                ...
                <aside>
                    <div class="submenu-item-box">
                        <div class="menuitem-title">Phụ kiện, loa<a href="/may-doi-tra/phu-kien">Tất cả</a></div>
                    ...
                    <div class="submenu-item-box">
                        <div class="menuitem-title">Viễn thông</div>
